...
[Python 3.9+] [License: MIT] [Status: Production Ready] [Deep Check: 100% Pass]

AI-powered leadership coaching device providing instant, personalized
guidance through natural voice interaction

Hold the spacebar, speak your leadership challenge, and receive immediate
AI-powered coaching feedback through high-quality audio responses.

QUICK LINKS
===========

- Quick Start - Get running in 5 minutes
- Spec-Driven Development: docs/settings/spec_driven_prompt.md
- Bootstrap Guide: docs/settings/bootstrap_py.md
- Technical Roadmap: docs/plans/technical_roadmap.md
- Product Roadmap: docs/plans/product_roadmap.md
...
MainLoop --> AudioHandler
MainLoop --> APIManager
APIManager --> SpeechClient
APIManager --> TTSClient
APIManager --> AIProvider
AudioHandler --> AudioPlaybackManager

ApplicationManager --> MainLoop
Configuration --> APIManager
...
This project uses Spec-Driven Development. See docs/settings/spec_driven_prompt.md
for complete workflow setup.
...
3. Follow Spec-Driven Development: See docs/settings/spec_driven_prompt.md
...
Last updated: 2025-01-03 | Version: 1.0 | Status: Production Ready
